...
public class TelaInicial extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("CAPTURE O INIMIGO");

        jButton1.setFont(new java.awt.Font("Alien Encounters", 0, 18)); // NOI18N
        ...
        jLabel1.setText("Capture o Inimigo!");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaInicial(new ControladorJogo()).setVisible(true);
            }
        });
    }
